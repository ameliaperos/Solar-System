...
export function drawStar(context, { color, name, radius, x: xStar, y: yStar, planets, scaleFactor }) {
  ...
  planets.forEach(function(planet, index) {
    const isEven = index % 2 === 0;
		...
		drawSpaceObject(context, planet.color, planet.name, planet.radius, planetX, planetY);
